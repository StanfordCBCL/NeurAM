...
1. By providing the low- and high-fidelity models as numerical functions implemented in Python. 
    ...
    * [An example of this mode using the Hartmann problem.](https://github.com/StanfordCBCL/NeurAM/tree/main/Hartmann)
2. By providing the inputs and outputs of the low- and high-fidelity models in files that are read by `NeurAM` package. 
    ...
    * [An example of this mode using patient-specific CFD simulations of coronary artery blood flow.](https://github.com/StanfordCBCL/NeurAM/tree/main/CoronaryArtery)
...
Note: For the format of the `.json` files storing the inputs and outputs, please look at the simulations directory in the [CoronaryArtery example](https://github.com/StanfordCBCL/NeurAM/tree/main/CoronaryArtery/simulations).
